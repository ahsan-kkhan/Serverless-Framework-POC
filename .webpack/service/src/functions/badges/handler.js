...
const createBadges = (0,_libs_lambda__WEBPACK_IMPORTED_MODULE_1__.middyfy)((event) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = {
            badgeId: (0,uuid__WEBPACK_IMPORTED_MODULE_3__["default"])(),
            badgeTitle: parsedBody.badgeTitle,
            badgeStatus: parsedBody.badgeStatus,
            badgeImage: parsedBody.badgeImage,
            isAdmin: true
        };
        const badges = yield _services_index__WEBPACK_IMPORTED_MODULE_2__["default"].createBadges(data);
        return badges;
    }
    catch (e) {
        console.log(e);
...
const updateBadges = (0,_libs_lambda__WEBPACK_IMPORTED_MODULE_1__.middyfy)((event) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const badges = yield _services_index__WEBPACK_IMPORTED_MODULE_2__["default"].updateBadges(parsedBody.badgeId, data);
        return badges;
    }
    catch (e) {
        return (0,_libs_api_gateway__WEBPACK_IMPORTED_MODULE_0__.formatJSONResponse)({
...
const deleteBadges = (0,_libs_lambda__WEBPACK_IMPORTED_MODULE_1__.middyfy)((event) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield _services_index__WEBPACK_IMPORTED_MODULE_2__["default"].deleteBadges(parsedBody);
        return "Deleted";
    }
    catch (e) {
        return (0,_libs_api_gateway__WEBPACK_IMPORTED_MODULE_0__.formatJSONResponse)({
